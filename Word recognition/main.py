...
path = os.path.normpath(os.getcwd() + os.sep + os.sep + os.pardir)
path1 = os.getcwd()

class FilePaths:
	"filenames and paths to data"
	fnCharList = path1 + '/model/charList.txt'
	fnAccuracy = path1 + '/model/accuracy.txt'
	fnTrain = path1 + '/data/'
	fnInfer = path + '/segmented words/'
	fnCorpus = path1 + '/data/corpus.txt'
